...
function render() {
  ...
  ms.push();
  ms.rotate(data.year*time, [0,0,1]); //  Edited moon's orbit to represent its yearly orbit speed
  ...
  ms.pop(); // popping Earth's position
